...
<html lang="en">
  ...
  <a class="navbar-brand" href="#" onclick="showAlert();><i class="fa fa-user-plus" aria-hidden="true"></i> Global Hospital </a>
...
<style>
  .description-cell {
    width: 300px; /* Adjust the width value as per your preference */
  }
</style>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <?php 
                    ...
                    $query = "SELECT pid, ID, fname, lname, gender, email, contact, appdate, apptime, userStatus, doctorStatus, description FROM appointmenttb WHERE doctor='$dname';";
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="#" data-toggle="modal" data-target="#descriptionModal<?php echo $row['ID']; ?>">Open</a>
                    </td>
                    <td>
                      <?php 
                  ...
                  <!-- Description Modal -->
                  <div class="modal fade" id="descriptionModal<?php echo $row['ID']; ?>" tabindex="-1" role="dialog" aria-labelledby="descriptionModalLabel<?php echo $row['ID']; ?>" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="descriptionModalLabel<?php echo $row['ID']; ?>">Description Details</h5>
